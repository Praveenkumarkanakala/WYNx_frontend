  ...
  return (
    ...
    <div className="home-container">
      ...
      <div className="main-content">
        <div className="text-content">
          ...
          <button className="nominate-button" onClick={() => navigate('/awardreg')}>
          Nominate
        </button>
        </div>
    ...
    <div className="recognition-container">
      ...
      <div className="recognition-content">
        ...
        <button className="nomination-button" onClick={() => navigate('/awardreg')}>
    ...
    <div className="winner-brands-container">
      ...
      <button className="nominate-newbutton" onClick={() => navigate('/awardreg')}>
        Nominate Now
      </button>
    </div>
