      ...
      <div className="newsletter-container">
        <div className="contact-grid">
          <div className="contact-column">
            <h2>For Nomination</h2>
            <div className="contact-details">
              <div className="divider"></div>
              <p className="name">Abhishek</p>
              <div className="divider"></div>
            </div>
            <p className="phone">+91 9958620920</p>
            <p className="email">abhishek@entrepreneurapj.com</p>
          </div>
          ...
          <div className="contact-column">
            ...
            <div className="contact-details">
              <div className="divider"></div>
              <p className="name">Prateek</p>
              <div className="divider"></div>
            </div>
            <p className="phone">+91 6354604762</p>
            <p className="email">prateek@entrepreneurapj.com</p>
          </div>
        </div>
      </div>
